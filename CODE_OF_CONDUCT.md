...
- Focusing on what is best for the community and the project, not just for us as
  individuals.
...
## A note on what this project reviews

Heimdall QA exists to describe what an API did, including the parts its owner did not
want to hear. A finding about somebody's API is not an attack on the person who wrote
it, and a review that turns into one will be closed. Critique the evidence, name the
code path, and leave the author out of it.
...
the maintainers responsible for enforcement through the repository's issue tracker at
<https://github.com/heimdall-qa/heimdall-qa/issues>, or privately through GitHub's
**Security → Report a vulnerability** flow when the report itself should not be public.
...
**1. Correction.** *Impact:* use of inappropriate language or other behaviour deemed
...
community spaces as well as external channels such as social media. Violating these
...
sustained inappropriate behaviour. *Consequence:* a temporary ban from any sort of
...
aggression toward or disparagement of classes of individuals. *Consequence:* a
