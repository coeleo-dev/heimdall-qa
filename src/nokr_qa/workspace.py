...
from nokr_qa.collection import TreeNode
from nokr_qa.collection import expand_to
from nokr_qa.collection import find_node
from nokr_qa.collection import find_step_dir
from nokr_qa.collection import first_startable
from nokr_qa.collection import index_workspace
from nokr_qa.collection import inspect_round
from nokr_qa.collection import parent_round
from nokr_qa.config import HarnessConfig
from nokr_qa.errors import HarnessError
from nokr_qa.session import QueueItem
from nokr_qa.session import RoundSession
from nokr_qa.session import SessionView
    ...
    def _require_startable(self) -> TreeNode:
        ...
        if round_node is None or not round_node.startable or not round_node.path:
            ...
            raise HarnessError(
                code="ROUND_INVALID",
                message=reason,
                hint="fix the round with nokr-qa validate, or pick a startable endpoint",
            )
        return round_node
